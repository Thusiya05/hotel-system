...
function AddDiscount(props){
    ...
    const url = "http://143.244.133.116:3030/manager/addDiscounts"
...
function AddRooms(props){
    const history = useHistory;
    const url = "http://143.244.133.116:3030/manager/addRooms"
    const [data,setData]=useState({
        roomNo:"",
        // roomTypeID:"",
        roomTypes:""
...
function AddRoomTypes(props){
    const url = "http://143.244.133.116:3030/manager/addRoomType"
    const [data,setData]= useState({
        roomTypeID:"",
        roomTypes:"",
        description:"",
...
function AddOutdoorActivities(props){
    ...
    // const url = "http://143.244.133.116:3030/manager/activity/addActivity"
    const url = "http://143.244.133.116:3030/outdoor-activities";
    const [data,setData]= useState({
        activityName:"",
        checkInTime:"",
        checkOutTime:"",
...
function EditRoomTypes(props){
    ...
    function submitt(e){
        e.preventDefault();
        // console.log(data);
        axios.put(`http://143.244.133.116:3030/manager/updateRoomType/${props.editRoomType}`,data)
        .then(res=>{
             props.setadded(!props.added);
             props.onHide();
             toast.success('✅ '+' '+ res.data);
    ...
    useEffect(() =>{
        axios.get(`http://143.244.133.116:3030/manager/viewUpdateRoomTypeDetails/${props.editRoomType}`)
        .then((res)=>{
            setData(res.data);
        })
    },[props.added])
...
function EditRooms(props){
    ...
    function submitt(e){
        e.preventDefault();
        // console.log(data);
        axios.put(`http://143.244.133.116:3030/manager/updateRooms/${props.editRoom}`,data)
        .then(res=>{
             props.setadded(!props.added);
             props.onHide();
             toast.success('✅ '+' '+ res.data);
    ...
    useEffect(() =>{
        axios.get(`http://143.244.133.116:3030/manager/viewUpdateRoomDetails/${props.editRoom}`)
        .then((res)=>{
...
function EditDiscount(props){
    ...
    function submit(e){
        e.preventDefault();
        // console.log(data);
        axios.put(`http://143.244.133.116:3030/manager/updateDiscounts/${props.editDiscount}`,data)
        .then(res=>{
             props.setadded(!props.added);
             props.onHide();
             toast.success('✅ '+' '+ res.data);
    ...
    useEffect(() =>{
        axios.get(`http://143.244.133.116:3030/manager/viewDiscountUpdateDetails/${props.editDiscount}`)
        .then((res)=>{
            setData(res.data);
...
function HotelConfig() {
    ...
    function DeleteRoomType(roomTypeID){
        axios.delete(`http://143.244.133.116:3030/manager/deleteRoomType/${roomTypeID}`)
        .then(res =>{
            toast.success('✅ '+' '+ res.data);
            setadded(!added);
        })
    ...
    function DeleteRoom(roomNo){
        axios.delete(`http://143.244.133.116:3030/manager/deleteRoom/${roomNo}`)
        .then(res =>{
            toast.success('✅ '+' '+ res.data);
            setadded(!added);
        })
    ...
    useEffect(() => {
            axios.get('http://143.244.133.116:3030/manager/viewRoomTypes')
            .then(res=>{
    ...
    useEffect(() => {
        axios.get('http://143.244.133.116:3030/manager/viewRooms')
        .then(res=>{
            setRooms(res.data)
        })
        .catch(err=>{
    ...
    useEffect(() => {
        axios.get('http://143.244.133.116:3030/manager/viewDiscounts')
        .then(res=>{
    ...
    useEffect(() => {
        //let url = 'http://143.244.133.116:3030/manager/activity/viewActivity';
        let url = 'http://143.244.133.116:3030/outdoor-activities';
        axios.get(url)
        .then(res=>{
