...
function AddUser(props) {
    const url = "http://143.244.133.116:3030/api/v1/addEmployee"
  ...
  function EditUser(props) {
    ...
    function submitt(e){
        e.preventDefault();
        // console.log(data);
        axios.put(`http://143.244.133.116:3030/api/v1/updateEmployee/${props.editemployees}`,data)
        .then(res=>{
             props.setadded(!props.added);
             props.onHide();
             toast.success('✅ '+' '+ res.data);
    ...
    useEffect(() => {
        axios.get(`http://143.244.133.116:3030/api/v1/viewEmployee/${props.editemployees}`)
        .then((res)=>{
...
//     // useEffect(() => {
//     //     axios.put(`http://143.244.133.116:3030/api/v1/deleteEmployee/${props.editemployees}`)
//     //     .then(res =>{
//     //         alert(res.data);
//     //         props.setadded(!props.added);
//     //     })
...
const Users =()=>{
    ...
    function Delete(id){
        axios.put(`http://143.244.133.116:3030/api/v1/deleteEmployee/${id}`)
        .then(res =>{
            toast.success('✅ '+' '+ res.data);
            setadded(!added);
        })
    ...
    useEffect(() => {
        axios.get('http://143.244.133.116:3030/api/v1/viewEmployeess/CUSTOMER')
        .then(res => {
    ...
    function getByName(e){
        if(e.target.value == ""){
            ...
            axios.get(`http://143.244.133.116:3030/api/v1/viewEmployeeByName/CUSTOMER/${e.target.value}`)
            .then(res => {
                setEmployees(res.data)
            })
            .catch(err => {
