...
function EditPendingCustomer(props) {
    ...
    function submitt(e){
        ...
        axios.put(`http://143.244.133.116:3030/receptionist/updateBookingStatus/${props.realId}`,data)
        .then(res=>{
...
const Customers=()=>{
    ...
    function DeleteStatus(realBookId){
        axios.delete(`http://143.244.133.116:3030/receptionist/deleteBooking/${realBookId}`)
        .then(res =>{
            toast.success('✅ '+' '+ res.data);
            setadded(!added);
        })
    ...
    useEffect(()=>{
        axios.get(`http://143.244.133.116:3030/receptionist/viewCustomers/${status}`)
        .then(res=>{
