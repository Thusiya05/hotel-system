...
function EditBooking(props) {
    ...
    function submitt(e){
        e.preventDefault();
        // console.log(data);
        axios.post(`/customer/booking/updatebooking/${props.bookingid}`,data)
        .then(res=>{
    ...
    useEffect(() => {
        axios.get(`/customer/booking/viewbookingbyid/${props.bookingid}`)
        .then((res)=>{
...
const MyBookings = ()=>{
    ...
    function Delete(id){
        axios.delete(`/customer/booking/deletebooking/${id}`)
        .then(res =>{
            toast.success('✅ '+' '+ res.data);
            setadded(!added);
        })
    ...
    const getOutdoorActivitySchedules = () =>{
        let url = "/outdoor-activity-schedules/customer-schedules";
        let body = {
    ...
    const deleteOutdoorActivitySchedule=(outdoorActivityScheduleId)=>{
        ...
        let url = `/outdoor-activity-schedules/${userId}/${outdoorActivityScheduleId}`;
    ...
    useEffect(() => {
        ...
        axios.get(`/customer/booking/viewbookings/${localStorage.getItem('userId')}`)
        .then(res => {
