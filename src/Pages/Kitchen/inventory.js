...
function Addingr(props){
    ...
    const url = "http://143.244.133.116:3030/addIngredient"
...
function Editingr(props){
    ...
    function submit(e){
        ...
        axios.post("http://143.244.133.116:3030/updateIngredientQty",{
...
function Inventory() {
    ...
    function Delete(ingredientId){
        ...
        console.log(currentDate)
            ...
            axios.post(`http://143.244.133.116:3030/deleteIngredient/${ingredientId}`,{
                currentDate: currentDate
            })
            .then(res=>{
                toast.success('✅ '+' '+ res.data);
            ...
            // axios.post(`http://143.244.133.116:3030/saveDeletedIngredientStatus/${ingredientId}`,{
            //     currentDate: currentDate
            // })
    }
    
    useEffect(() => {
        axios.get('http://143.244.133.116:3030/ingredientsHaveToReFill')
        .then(res => {
    ...
    useEffect(() => {
        axios.get('http://143.244.133.116:3030/ingredientsStillNotHaveToReFill')
        .then(res => {
