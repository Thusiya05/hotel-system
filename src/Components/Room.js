...
useEffect(() => {
  axios.get(`http://143.244.133.116:3030/customer/booking/getroomnumbers/${props.roomName}/${data.checkInDate}/${data.checkOutDate}`)
  .then((res)=>{
      // setMaxroom(res.data);
  ...
  function submit(e){
        e.preventDefault();
        axios.post(`http://143.244.133.116:3030/customer/booking/addbooking`,data)
        .then(res=>{
          props.onHide();
          setData({
            checkInDate: "",
